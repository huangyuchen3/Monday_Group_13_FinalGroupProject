 ...
 */
package userinterface.ACPManagerRole;
...
public class PantryStockPanel extends javax.swing.JPanel {
    ...
    private void populatePantryItemsTable() {
        ...
        for(DropOffItems fcpi: ecosystem.getACDOIDirectory().getDOiList()){
            System.out.println(fcpi.getDropOffManager()+ "dfsdgs");
            if(fcpi.getDropOffManager().equals(userAcc.getEmployee().getName())){
           Object[] row = new Object[3];
           row[0] =fcpi;
           row[1] =fcpi.getAccessoryItems();
           row[2] =fcpi.getAccessoryQuantity();
           model.addRow(row);
            }
        } 
    }
