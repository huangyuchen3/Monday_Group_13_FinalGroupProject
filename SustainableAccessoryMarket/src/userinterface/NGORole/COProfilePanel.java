 ...
 * @author ankitapatil 
 */
public class COProfilePanel extends javax.swing.JPanel {

    /**
     * Creates new form COProfilePanel
     */
    ...
    public COProfilePanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(COProfilePanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnNonGovOrgSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNonGovOrgSubmitActionPerformed
        ...
        if(!nullCheck()){
            ...
            for(CommunityOutreach d: nogList)
            {
                if(d.getCOAccount().getUsername().equals(NGOUname))
                {
                    d.setCOName(txtNonGovOrgname.getText());
                    d.setCOPhone(txtNonGovOrgPhone.getText());
                    d.setCOAgent(txtNonGovOrgAgent.getText());
                    d.setCOAddress(txtNonGovOrgadd.getText());
                    d.setCOCity(txtNonGovOrgcity.getText());
                    d.setCOState(txtNonGovOrgstate.getText());
                    d.setCOZipcode(txtNonGovOrgzip.getText());
    ...
    private void populateFields() {
        for(CommunityOutreach d: ecosystem.getcoDir().getNgoList()){
            if(d.getCOAgent().equals(ngoAname)){
            txtNonGovOrgname.setText(d.getCOName());
            txtNonGovOrgname.setEnabled(false);
            txtNonGovOrgPhone.setText(d.getCOPhone());
            txtNonGovOrgPhone.setEnabled(false);
            txtNonGovOrgAgent.setText(d.getCOAgent());
            txtNonGovOrgAgent.setEnabled(false);
            txtNonGovOrgadd.setText(d.getCOAddress());
            txtNonGovOrgadd.setEnabled(false);
            txtNonGovOrgcity.setText(d.getCOCity());
            txtNonGovOrgcity.setEnabled(false);
            txtNonGovOrgstate.setText(d.getCOState());
            txtNonGovOrgstate.setEnabled(false);
            txtNonGovOrgzip.setText(d.getCOZipcode());
            txtNonGovOrgzip.setEnabled(false);
            txtNonGovOrguname.setText(d.getCOAccount().getUsername());
            txtNonGovOrguname.setEnabled(false);
            txtNonGovOrgpwd.setText(d.getCOAccount().getPassword());
